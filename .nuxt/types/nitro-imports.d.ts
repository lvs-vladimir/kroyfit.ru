declare global {
  ...
  const initializeDatabase: typeof import('../../server/utils/init-db').initializeDatabase
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/root/kroyfit/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/root/kroyfit/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { initializeDatabase } from '/root/kroyfit/server/utils/init-db';