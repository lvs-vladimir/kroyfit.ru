import { ref, readonly, computed, toRef, isRef, toValue, createElementVNode, Fragment, normalizeClass, useId, provide, inject, watch, reactive, unref, toRefs, shallowRef, Text, createVNode, normalizeStyle, resolveDynamicComponent, TransitionGroup, Transition, h, mergeProps } from "vue";
import { k as includes, p as propsFactory, l as isPrimitive, o as getCurrentInstance, t as templateRef, q as getCurrentInstanceName, s as destructComputed, v as isCssColor, w as isParsableColor, x as parseColor, y as hasLightForeground, z as useProxiedModel, A as wrapInArray, B as findChildrenWithProvide, C as consoleWarn, g as genericComponent, h as provideDefaults, j as convertToUnit, D as useTheme, E as useIcon, m as makeThemeProps, I as IconValue, F as flattenFragments, G as useRtl, H as hasEvent, J as isObject, P as PREFERS_REDUCED_MOTION, K as onlyDefinedProps } from "../server.mjs";
...
export {
  ...
  deepEqual as D,
  useBackgroundColor as E,
  makeTransitionProps as F,
  VFadeTransition as G,
  VExpandXTransition as H,
  Intersect as I,
  VSlideYTransition as J,
  Box as K,
  VExpandTransition as L,
  ...
  useLink as v,
  useVariant as w,
  makeRouterProps as x,
  makeLocationProps as y,
  makeGroupItemProps as z
};
//# sourceMappingURL=index-CXrZw6YX.js.map
