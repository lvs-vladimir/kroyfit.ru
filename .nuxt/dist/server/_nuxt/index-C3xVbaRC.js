...
import { _ as __nuxt_component_0$1 } from "./nuxt-link-D9A4Nul8.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({
        class: ["app-header", { scrolled: unref(isScrolled) }]
      }, _attrs))} data-v-a750e37c><div class="container-max" data-v-a750e37c><div class="header-content" data-v-a750e37c><div class="logo" data-v-a750e37c><span class="logo-icon" data-v-a750e37c>✂️</span><span class="logo-text" data-v-a750e37c>Генетика Кроя</span></div><nav class="nav-menu" data-v-a750e37c><a href="#courses" class="nav-link" data-v-a750e37c>Курсы</a><a href="#about" class="nav-link" data-v-a750e37c>О нас</a><a href="#results" class="nav-link" data-v-a750e37c>Результаты</a><a href="#contacts" class="nav-link" data-v-a750e37c>Контакты</a></nav><button class="btn-primary" data-v-a750e37c>Записаться</button></div></div></header>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-a750e37c"]]), { __name: "AppHeader" });
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-9c57a82f"]]), { __name: "HeroSection" });
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-aa56e697"]]), { __name: "PainPoints" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: "courses",
        id: "courses"
      }, _attrs))} data-v-c4ce2f41><div class="container-max" data-v-c4ce2f41><div class="section-header" data-v-c4ce2f41><p class="section-tag text-uppercase text-accent" data-v-c4ce2f41>Обучение</p><h2 class="section-title" data-v-c4ce2f41>Наши курсы</h2></div><div class="courses-grid" data-v-c4ce2f41><!--[-->`);
      ssrRenderList(unref(courses), (course, index2) => {
        _push(`<div class="${ssrRenderClass([`reveal-stagger-${index2 + 1}`, "course-card"])}" data-v-c4ce2f41><div class="course-header" data-v-c4ce2f41><h3 class="course-title" data-v-c4ce2f41>${ssrInterpolate(course.title)}</h3><span class="course-level" data-v-c4ce2f41>${ssrInterpolate(course.level)}</span></div><div class="course-details" data-v-c4ce2f41><div class="detail" data-v-c4ce2f41><span class="detail-icon" data-v-c4ce2f41>⏱️</span><span class="detail-text" data-v-c4ce2f41>${ssrInterpolate(course.duration)}</span></div><div class="detail" data-v-c4ce2f41><span class="detail-icon" data-v-c4ce2f41>📚</span><span class="detail-text" data-v-c4ce2f41>${ssrInterpolate(course.lessons)} уроков</span></div></div><p class="course-description" data-v-c4ce2f41>${ssrInterpolate(course.description)}</p><div class="course-skills" data-v-c4ce2f41><p class="skills-label" data-v-c4ce2f41>Вы научитесь:</p><ul class="skills-list" data-v-c4ce2f41><!--[-->`);
        ssrRenderList(course.skills, (skill) => {
          _push(`<li data-v-c4ce2f41>${ssrInterpolate(skill)}</li>`);
        });
        _push(`<!--]--></ul></div><div class="course-footer" data-v-c4ce2f41><div class="course-price" data-v-c4ce2f41>${ssrInterpolate(course.price)} ₽</div>`);
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-c4ce2f41"]]), { __name: "CoursesSection" });
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-b35f88cc"]]), { __name: "ResultsSection" });
...
const __nuxt_component_5 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-53da389b"]]), { __name: "AboutSection" });
const _sfc_main$2 = {};
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-75d2eafa"]]), { __name: "CtaBanner" });
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "contacts",
    id: "contacts"
  }, _attrs))} data-v-32d1d187><div class="container-max" data-v-32d1d187><div class="contacts-grid" data-v-32d1d187><div class="contact-block" data-v-32d1d187><h3 class="contact-title" data-v-32d1d187>Телефон</h3><p class="contact-value" data-v-32d1d187>8 913 210-16-62</p><p class="contact-hours" data-v-32d1d187>Пн-Пт: 10:00 - 18:00</p></div><div class="contact-block" data-v-32d1d187><h3 class="contact-title" data-v-32d1d187>Адрес</h3><p class="contact-value" data-v-32d1d187>ул. Профинтерна 7А</p><p class="contact-hours" data-v-32d1d187>Барнаул, Алтайский край</p></div><div class="contact-block" data-v-32d1d187><h3 class="contact-title" data-v-32d1d187>Соцсети</h3><div class="social-links" data-v-32d1d187><a href="https://vk.com/genetikakroya22" target="_blank" class="social-link" data-v-32d1d187>ВКонтакте</a><a href="https://instagram.com" target="_blank" class="social-link" data-v-32d1d187>Instagram</a></div></div></div><div class="contacts-footer" data-v-32d1d187><p class="footer-text" data-v-32d1d187> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Генетика Кроя. Все права защищены. </p></div></div></section>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ContactsSection.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_7 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-32d1d187"]]), { __name: "ContactsSection" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Авторская методика точного кроя по Злачевской. Идеальная посадка одежды без примерок. Обучение в Барнауле с 2014 года.",
      ogImage: "https://images.unsplash.com/photo-1558618666-fcd25c85cd62?w=1200&h=630&fit=crop"
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppHeader = __nuxt_component_0;
      const _component_HeroSection = __nuxt_component_1;
      const _component_PainPoints = __nuxt_component_2;
      const _component_CoursesSection = __nuxt_component_3;
      const _component_ResultsSection = __nuxt_component_4;
      const _component_AboutSection = __nuxt_component_5;
      const _component_CtaBanner = __nuxt_component_6;
      const _component_ContactsSection = __nuxt_component_7;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "landing-page" }, _attrs))} data-v-b2423dd9>`);
      ...
      _push(ssrRenderComponent(_component_ContactsSection, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b2423dd9"]]);
export {
  index as default
};
//# sourceMappingURL=index-C3xVbaRC.js.map
