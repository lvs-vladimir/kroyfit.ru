import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject as inject$1, toRef, warn, watchEffect, capitalize, shallowRef, Fragment, camelize, isVNode, Comment, unref, ref, computed, provide, defineComponent as defineComponent$1, toValue, createVNode, mergeProps, createElementVNode, normalizeClass, h, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, toRefs, defineAsyncComponent, Suspense, nextTick, createElementBlock, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/root/kroyfit/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/root/kroyfit/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/root/kroyfit/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/root/kroyfit/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "/root/kroyfit/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/root/kroyfit/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/new-BZ8WaBCB.js")
  },
  {
    name: "admin-courses-id",
    path: "/admin/courses/:id()",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-BfgyUSHS.js")
  },
  {
    name: "admin-users-id",
    path: "/admin/users/:id()",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-CoXmRSgt.js")
  },
  {
    name: "admin-courses",
    path: "/admin/courses",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-BoLuUVHt.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/login-B-3T_VOT.js")
  },
  {
    name: "admin-plan",
    path: "/admin/plan",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-snSjspbL.js")
  },
  {
    name: "admin-purchases",
    path: "/admin/purchases",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-MKzYB-Wa.js")
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-j8hy10jL.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-Bp7WcGf7.js")
  },
  {
    name: "courses-slug",
    path: "/courses/:slug()",
    component: () => import("./_nuxt/_slug_-CDowzmc2.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-lT6htD6q.js")
  },
  {
    name: "cabinet",
    path: "/cabinet",
    component: () => import("./_nuxt/index-DKxr7Ecg.js")
  },
  {
    name: "payment-success",
    path: "/payment-success",
    component: () => import("./_nuxt/payment-success-DddzDd8n.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/index-CZsRJx7V.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CLaQcmAa.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-D8JCC4y_.js"),
  test: () => import("./_nuxt/test-D4Sys7p8.js")
};
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light", "themes": { "light": { "colors": { "primary": "#00DC82", "secondary": "#6366F1", "accent": "#06B6D4", "error": "#EF4444", "warning": "#F59E0B", "info": "#3B82F6", "success": "#10B981", "background": "#F8FAFC", "surface": "#FFFFFF", "surface-dim": "#F1F5F9" } } } }, "ssr": true };
  return options;
}
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-B-8Bw2tG.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-B0QpqdW1.js").then((m) => m.default || m))
};
...
const ServerPlaceholder = defineComponent$1({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DRXQg1v_.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Do2nex-F.js"));
...
export {
  getPropertyFromItem as $,
  getCurrentInstanceName as A,
  destructComputed as B,
  isCssColor as C,
  isParsableColor as D,
  parseColor as E,
  hasLightForeground as F,
  ...
  onlyDefinedProps as Q,
  keys as R,
  breakpoints as S,
  deprecate as T,
  useDisplay as U,
  matchesSelector as V,
  isClickInsideElement as W,
  focusChild as X,
  getNextElement as Y,
  focusableChildren as Z,
  _export_sfc as _,
  useRouter as a,
  debounce as a0,
  ...
  checkPrintable as a4,
  useGoTo as a5,
  makeDisplayProps as a6,
  EventProp as a7,
  pick as a8,
  standardEasing as a9,
  consoleError as aa,
  defineComponent as ab,
  pickWithRest as ac,
  acceleratedEasing as ad,
  deceleratedEasing as ae,
  CircularBuffer as af,
  defer as ag,
  asyncDataDefaults as ah,
  createError as ai,
  fetchDefaults as aj,
  defineNuxtRouteMiddleware as ak,
  useLocale as b,
