...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-6a18652d><div class="d-flex align-center mb-6" data-v-6a18652d>`);
      ...
      _push(`<div data-v-6a18652d><h1 class="text-h4 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-6a18652d>${ssrInterpolate(unref(isEdit) ? "Редактирование" : "Новый курс")}</h1><p class="text-body-2 text-grey-darken-1" data-v-6a18652d>${ssrInterpolate(unref(isEdit) ? "Изменение данных курса" : "Заполните информацию о курсе")}</p></div></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VForm, { onSubmit: saveCourse }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="mb-6" data-v-6a18652d${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId3}>Название</label>`);
                        ...
                        _push4(`</div><div class="mb-6" data-v-6a18652d${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId3}>Описание</label>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId5}>Цена (₽)</label>`);
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId5}>Длительность</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId5}>Категория</label>`);
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-6a18652d${_scopeId5}>Уроков</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                        ...
                        _push4(`<div class="d-flex ga-2" data-v-6a18652d${_scopeId3}>`);
            ...
            _push2(ssrRenderComponent(VCol, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="preview-card" data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1 font-weight-medium mb-4" data-v-6a18652d${_scopeId2}>Предпросмотр</p><div class="mb-4" data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-6a18652d${_scopeId2}>Название</p><p class="text-body-2 font-weight-medium" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-6a18652d${_scopeId2}>${ssrInterpolate(unref(form).title || "Название курса")}</p></div><div class="mb-4" data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-6a18652d${_scopeId2}>Цена</p><p class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-6a18652d${_scopeId2}>${ssrInterpolate(unref(form).price ? `${unref(form).price} ₽` : "0 ₽")}</p></div><div class="mb-4" data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-6a18652d${_scopeId2}>Категория</p>`);
                  ...
                  _push3(`</div><div class="mb-4" data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-6a18652d${_scopeId2}>Статус</p>`);
                  _push3(ssrRenderComponent(VChip, {
                    size: "x-small",
                  ...
                  _push3(`<div data-v-6a18652d${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-6a18652d${_scopeId2}>Описание</p><p class="text-body-2" data-v-6a18652d${_scopeId2}>${ssrInterpolate(unref(form).description || "Описание курса")}</p></div></div>`);
                } else {
                  return [
...
const _new = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6a18652d"]]);

export { _new as default };
//# sourceMappingURL=new-BNeNo-ln.mjs.map
