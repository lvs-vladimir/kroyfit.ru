import { defineComponent, ref, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VContainer, { class: "d-flex align-center" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#6366F1" })}" data-v-15485fef${_scopeId3}> ✂️ ${ssrInterpolate(_ctx.siteName)}</div>`);
                        ...
                        return [
                          createVNode("div", {
                            ...
                            style: { "color": "#6366F1" }
                          }, " ✂️ " + toDisplayString(_ctx.siteName), 1),
                          createVNode(VSpacer),
                          createVNode(VBtn, {
                            variant: "text",
                            href: "#courses",
            ...
            _push2(ssrRenderComponent(VMain, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<section class="hero-section py-20" data-v-15485fef${_scopeId2}>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mb-6" data-v-15485fef${_scopeId5}><h1 class="text-h2 font-weight-800 mb-4 gradient-text" data-v-15485fef${_scopeId5}> Шейте одежду<br data-v-15485fef${_scopeId5}>как вторая кожа </h1></div><p class="text-h6 text-medium-emphasis mb-8" style="${ssrRenderStyle({ "max-width": "600px", "margin": "0 auto", "line-height": "1.6" })}" data-v-15485fef${_scopeId5}> Методика точного кроя по Злачевской. Научим вы создавать идеальную посадку без примерок и подгонок. </p><div id="vk-login-container" class="mb-8" data-v-15485fef${_scopeId5}></div><div class="d-flex flex-wrap justify-center ga-4 mb-12" data-v-15485fef${_scopeId5}>`);
                                        ...
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-h4 font-weight-800" style="${ssrRenderStyle({ "color": "#6366F1" })}" data-v-15485fef${_scopeId7}>12+</div><p class="text-body-2 text-medium-emphasis" data-v-15485fef${_scopeId7}>лет опыта</p>`);
                                              } else {
                                                return [
                                                  createVNode("div", {
                                          ...
                                          _push7(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-h4 font-weight-800" style="${ssrRenderStyle({ "color": "#EC4899" })}" data-v-15485fef${_scopeId7}>500+</div><p class="text-body-2 text-medium-emphasis" data-v-15485fef${_scopeId7}>выпускниц</p>`);
                                              } else {
                                                return [
                                                  createVNode("div", {
                                                    class: "text-h4 font-weight-800",
                                          ...
                                          _push7(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="text-h4 font-weight-800" style="${ssrRenderStyle({ "color": "#06B6D4" })}" data-v-15485fef${_scopeId7}>5.0★</div><p class="text-body-2 text-medium-emphasis" data-v-15485fef${_scopeId7}>рейтинг</p>`);
                                              } else {
                                                return [
                                                  createVNode("div", {
                                                    class: "text-h4 font-weight-800",
                  ...
                  _push3(`</section><section class="py-20" style="${ssrRenderStyle({ "background": "linear-gradient(135deg, #F8FAFC 0%, #F1F5F9 100%)" })}" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h3 font-weight-800 text-center mb-12 gradient-title" data-v-15485fef${_scopeId3}> Знакомые проблемы? </h2>`);
                                      ...
                                      _push6(ssrRenderComponent(VCard, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(`<p class="text-body-1 font-weight-600" data-v-15485fef${_scopeId6}>${ssrInterpolate(problem.title)}</p>`);
                                          } else {
                                            return [
                                              createVNode(VIcon, {
                                                size: "48",
                  ...
                  _push3(`</section><section id="courses" class="py-20" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h3 font-weight-800 text-center mb-12 gradient-title" data-v-15485fef${_scopeId3}> Наши курсы </h2>`);
                        _push4(ssrRenderComponent(VRow, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VCard, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<div class="course-image-wrapper" data-v-15485fef${_scopeId6}>`);
                                            ...
                                            _push7(`<div class="course-overlay" data-v-15485fef${_scopeId6}></div>`);
                                            ...
                                            _push7(ssrRenderComponent(VCardText, { class: "pa-6" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<h3 class="text-h6 font-weight-800 mb-3" data-v-15485fef${_scopeId7}>${ssrInterpolate(course.title)}</h3><p class="text-body-2 text-medium-emphasis mb-6 line-clamp-2" data-v-15485fef${_scopeId7}>${ssrInterpolate(course.description)}</p><div class="mb-6" data-v-15485fef${_scopeId7}><div class="d-flex align-center mb-2" data-v-15485fef${_scopeId7}>`);
                                                  ...
                                                  _push8(`<span class="text-caption" data-v-15485fef${_scopeId7}>${ssrInterpolate(course.duration)}</span></div><div class="d-flex align-center" data-v-15485fef${_scopeId7}>`);
                                                  _push8(ssrRenderComponent(VIcon, {
                                                    size: "18",
                                                    color: "primary",
                                                    class: "mr-2"
                                                  ...
                                                  _push8(`<span class="text-caption" data-v-15485fef${_scopeId7}>${ssrInterpolate(course.lessonsCount)} уроков</span></div></div>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(VCardActions, { class: "pa-6 d-flex justify-space-between align-center" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span class="text-h6 font-weight-800 price-text" data-v-15485fef${_scopeId7}>${ssrInterpolate(course.priceDisplay)}</span>`);
                              ...
                              return [
                                (openBlock(), createBlock(Fragment, null, renderList(courses, (course) => {
                                  return createVNode(VCol, {
                                    key: course.id,
                                    cols: "12",
                                    md: "4"
                  ...
                  _push3(`</section><section class="py-20 gradient-bg-primary" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, { class: "text-white" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h3 font-weight-800 text-center mb-12" data-v-15485fef${_scopeId3}> Результаты наших учениц </h2>`);
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(results, (result) => {
                                _push5(ssrRenderComponent(VCol, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-center" data-v-15485fef${_scopeId5}>`);
                                      ...
                                      _push6(`<p class="text-h6 font-weight-800 mb-2" data-v-15485fef${_scopeId5}>${ssrInterpolate(result.title)}</p><p class="text-body-2 opacity-80" data-v-15485fef${_scopeId5}>${ssrInterpolate(result.desc)}</p></div>`);
                                    } else {
                                      return [
                  ...
                  _push3(`</section><section id="about" class="py-20" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VRow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<h2 class="text-h3 font-weight-800 mb-4 gradient-title" data-v-15485fef${_scopeId5}> Людмила Лукьянова </h2><p class="text-h6 text-medium-emphasis mb-6" data-v-15485fef${_scopeId5}> Конструктор-модельер швейных изделий </p><p class="text-body-1 mb-6 line-height-lg" data-v-15485fef${_scopeId5}> Мастер с полувековым опытом. Научу шить одежду сидящую как вторая кожа! Я умею множить радость✨ </p>`);
                  ...
                  _push3(`</section><section class="py-20 gradient-bg-secondary" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, { class: "text-center text-white" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h3 font-weight-800 mb-4" data-v-15485fef${_scopeId3}> Начните обучение сегодня </h2><p class="text-h6 mb-8 opacity-90" data-v-15485fef${_scopeId3}> Первый шаг к идеальной посадке одежды </p><div class="d-flex flex-wrap justify-center ga-4" data-v-15485fef${_scopeId3}>`);
                        _push4(ssrRenderComponent(VBtn, {
                          color: "white",
                          size: "x-large",
                          href: "https://vk.com/write-53091601",
                  ...
                  _push3(`</section><section id="contacts" class="py-20" style="${ssrRenderStyle({ "background": "#F8FAFC" })}" data-v-15485fef${_scopeId2}>`);
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h3 font-weight-800 text-center mb-12 gradient-title" data-v-15485fef${_scopeId3}> Контакты </h2>`);
                        _push4(ssrRenderComponent(VRow, { justify: "center" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(VCol, {
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<h3 class="text-h6 font-weight-800 mb-6" data-v-15485fef${_scopeId8}>Свяжитесь с нами</h3>`);
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`<a href="tel:89132101662" class="text-decoration-none contact-link" data-v-15485fef${_scopeId11}> 8 913 210-16-62 </a><br data-v-15485fef${_scopeId11}><small class="text-medium-emphasis" data-v-15485fef${_scopeId11}>Людмила</small>`);
                                                                      } else {
                                                                        return [
                                                                          createVNode("a", {
                                                                            href: "tel:89132101662",
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`<a href="tel:89132790097" class="text-decoration-none contact-link" data-v-15485fef${_scopeId11}> 8 913 279-00-97 </a><br data-v-15485fef${_scopeId11}><small class="text-medium-emphasis" data-v-15485fef${_scopeId11}>Юлия</small>`);
                                                                      } else {
                                                                        return [
                                                                          createVNode("a", {
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(`<a href="mailto:missispip@mail.ru" class="text-decoration-none contact-link" data-v-15485fef${_scopeId11}> missispip@mail.ru </a>`);
                                                                      } else {
                                                                        return [
                                                                          createVNode("a", {
                                                ...
                                                _push8(ssrRenderComponent(VCol, {
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<h3 class="text-h6 font-weight-800 mb-6" data-v-15485fef${_scopeId8}>Адрес</h3>`);
                                                      _push9(ssrRenderComponent(VList, { class: "bg-transparent" }, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(VListItem, { class: "px-0 mb-4" }, {
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(VListItemTitle, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(` ул. Профинтерна 7А<br data-v-15485fef${_scopeId11}> Барнаул `);
                                                                      } else {
                                                                        return [
                        ...
                        _push4(ssrRenderComponent(VContainer, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCol, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h4 class="text-h6 font-weight-800 mb-3" data-v-15485fef${_scopeId6}>${ssrInterpolate(_ctx.siteName)}</h4><p class="text-body-2 text-grey-lighten-2" data-v-15485fef${_scopeId6}> Курсы кройки и шитья в Барнауле с 2014 года. Методика точного кроя по Злачевской. </p>`);
                                        } else {
                                          return [
                                            createVNode("h4", { class: "text-h6 font-weight-800 mb-3" }, toDisplayString(_ctx.siteName), 1),
                                    ...
                                    _push6(ssrRenderComponent(VCol, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h4 class="text-h6 font-weight-800 mb-3" data-v-15485fef${_scopeId6}>Быстрые ссылки</h4>`);
                                    ...
                                    _push6(ssrRenderComponent(VCol, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h4 class="text-h6 font-weight-800 mb-3" data-v-15485fef${_scopeId6}>Соцсети</h4><div class="d-flex ga-2" data-v-15485fef${_scopeId6}>`);
                              ...
                              _push5(`<p class="text-center text-caption text-grey-lighten-3" data-v-15485fef${_scopeId4}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} ${ssrInterpolate(_ctx.siteName)}. Все права защищены. </p>`);
                            } else {
                              return [
                                createVNode(VRow, null, {
                                  default: withCtx(() => [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-15485fef"]]);

export { index as default };
//# sourceMappingURL=index-NJZZEOic.mjs.map
