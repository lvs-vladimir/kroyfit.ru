...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-4742ce05><div class="d-flex align-center mb-6" data-v-4742ce05><div data-v-4742ce05><h1 class="text-h4 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-4742ce05>Курсы</h1><p class="text-body-2 text-grey-darken-1" data-v-4742ce05>Управление курсами школы</p></div>`);
      ...
      _push(ssrRenderComponent(VTable, { class: "courses-table" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<thead data-v-4742ce05${_scopeId}><tr data-v-4742ce05${_scopeId}><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-4742ce05${_scopeId}>Название</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-4742ce05${_scopeId}>Категория</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-4742ce05${_scopeId}>Цена</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-4742ce05${_scopeId}>Статус</th><th class="text-right text-caption text-grey-darken-1 font-weight-medium" data-v-4742ce05${_scopeId}>Действия</th></tr></thead><tbody data-v-4742ce05${_scopeId}><!--[-->`);
            ssrRenderList(unref(courses), (course) => {
              _push2(`<tr data-v-4742ce05${_scopeId}><td class="font-weight-medium" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-4742ce05${_scopeId}>${ssrInterpolate(course.title)}</td><td class="text-grey-darken-2" data-v-4742ce05${_scopeId}>${ssrInterpolate(course.category)}</td><td class="text-grey-darken-2" data-v-4742ce05${_scopeId}>${ssrInterpolate(course.priceDisplay)}</td><td data-v-4742ce05${_scopeId}>`);
              ...
              _push2(`</td><td class="text-right" data-v-4742ce05${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4742ce05"]]);

export { index as default };
//# sourceMappingURL=index-BrNoHVvC.mjs.map
