...
import { V as VIcon, a as useDensity, E as useBackgroundColor, j as useRender, z as useTextColor, y as useGroup, g as useGroupItem, M as MaybeTransition, k as makeTagProps, t as makeDensityProps, v as makeComponentProps, q as makeGroupItemProps } from './index-C1EJcibQ.mjs';
...
import { u as useLazy, c as makeLazyProps } from './VOverlay-BtXALeZH.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-37520040><div class="mb-6" data-v-37520040><h1 class="text-h4 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040>Настройки</h1><p class="text-body-2 text-grey-darken-1" data-v-37520040>Конфигурация системы</p></div>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold mb-6" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>Мой профиль</h2>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Email</label>`);
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Имя</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-6" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Новый пароль</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex align-center mb-6" data-v-37520040${_scopeId3}><div data-v-37520040${_scopeId3}><h2 class="text-h6 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>Роли и разрешения</h2></div>`);
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VCard, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<div class="d-flex align-center mb-4" data-v-37520040${_scopeId6}><div class="flex-grow-1" data-v-37520040${_scopeId6}><h3 class="text-subtitle-1 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId6}>${ssrInterpolate(role.name)}</h3><p class="text-caption text-grey-darken-1 mb-0" data-v-37520040${_scopeId6}>${ssrInterpolate(role.description)}</p></div>`);
                                            ...
                                            _push7(`<div class="permissions-list" data-v-37520040${_scopeId6}><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Dashboard</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Курсы</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Пользователи</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Покупки</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Настройки</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>Администраторы</span></div><div class="permission-item" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                            ...
                                            _push7(`<span class="text-caption" data-v-37520040${_scopeId6}>План</span></div></div>`);
                                          } else {
                                            return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h2 class="text-h6 font-weight-bold" data-v-37520040${_scopeId6}>${ssrInterpolate(unref(editingRole) ? "Редактирование" : "Добавление")} роли</h2>`);
                                        } else {
                                          return [
                                    ...
                                    _push6(ssrRenderComponent(VCardText, { class: "pa-6" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Название роли</label>`);
                                          ...
                                          _push7(`</div><div class="mb-6" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Описание</label>`);
                                          ...
                                          _push7(`</div><h3 class="text-subtitle-2 font-weight-bold mb-3" data-v-37520040${_scopeId6}>Разрешения</h3>`);
                                          ...
                                          _push7(`<div class="d-flex ga-2" data-v-37520040${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VBtn, {
                                            color: "green-darken-3",
                                            variant: "flat",
                                            onClick: saveRole,
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex align-center mb-6" data-v-37520040${_scopeId3}><h2 class="text-h6 font-weight-bold mb-0" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>Администраторы</h2>`);
                        _push4(ssrRenderComponent(VSpacer, null, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VBtn, {
                          color: "green-darken-3",
                          variant: "flat",
                        ...
                        _push4(ssrRenderComponent(VTable, { class: "data-table" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<thead data-v-37520040${_scopeId4}><tr data-v-37520040${_scopeId4}><th class="text-left" data-v-37520040${_scopeId4}>Email</th><th class="text-left" data-v-37520040${_scopeId4}>Имя</th><th class="text-left" data-v-37520040${_scopeId4}>Роль</th><th class="text-left" data-v-37520040${_scopeId4}>Действия</th></tr></thead><tbody data-v-37520040${_scopeId4}><!--[-->`);
                              ssrRenderList(unref(admins), (admin) => {
                                _push5(`<tr data-v-37520040${_scopeId4}><td class="font-weight-medium" data-v-37520040${_scopeId4}>${ssrInterpolate(admin.email)}</td><td data-v-37520040${_scopeId4}>${ssrInterpolate(admin.name)}</td><td data-v-37520040${_scopeId4}>`);
                                ...
                                _push5(`</td><td data-v-37520040${_scopeId4}>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h2 class="text-h6 font-weight-bold" data-v-37520040${_scopeId6}>${ssrInterpolate(unref(editingAdmin) ? "Редактирование" : "Добавление")} администратора</h2>`);
                                        } else {
                                          return [
                                    ...
                                    _push6(ssrRenderComponent(VCardText, { class: "pa-6" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Email</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          _push7(`</div><div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Имя</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          _push7(`</div><div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Роль</label>`);
                                          ...
                                          _push7(`</div><div class="d-flex ga-2" data-v-37520040${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VBtn, {
                                            color: "green-darken-3",
                                            variant: "flat",
                                            onClick: saveAdmin,
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h2 class="text-h6 font-weight-bold" data-v-37520040${_scopeId6}>Изменение пароля</h2>`);
                                        } else {
                                          return [
                                    ...
                                    _push6(ssrRenderComponent(VCardText, { class: "pa-6" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Администратор</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          _push7(`</div><div class="mb-6" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Новый пароль</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex align-center mb-6" data-v-37520040${_scopeId3}><h2 class="text-h6 font-weight-bold mb-0" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>ВКонтакте</h2>`);
                        _push4(ssrRenderComponent(VSpacer, null, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VBtn, {
                          color: "green-darken-3",
                          variant: "flat",
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VCard, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<div class="d-flex align-center mb-4" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                              color: "blue",
                                              class: "mr-3"
                                            }, {
                                            ...
                                            _push7(`<div class="flex-grow-1" data-v-37520040${_scopeId6}><h3 class="text-subtitle-1 font-weight-bold mb-0" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId6}>${ssrInterpolate(group.name)}</h3></div>`);
                                            _push7(ssrRenderComponent(VBtn, {
                                              icon: "",
                                              size: "small",
                                              variant: "text",
                                            ...
                                            _push7(`</div><div class="mb-3" data-v-37520040${_scopeId6}><p class="text-caption text-grey-darken-1 mb-1" data-v-37520040${_scopeId6}><a${ssrRenderAttr("href", `https://vk.com/${group.vkId}`)} target="_blank" class="text-decoration-none" style="${ssrRenderStyle({ "color": "#1976d2" })}" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                              size: "14",
                                              color: "blue"
                                            }, {
                                            ...
                                            _push7(` vk.com/${ssrInterpolate(group.vkId)}</a></p><p class="text-caption text-grey-darken-1" data-v-37520040${_scopeId6}>Курс: ${ssrInterpolate(group.courseSlug)}</p></div>`);
                                          } else {
                                            return [
                                              createVNode("div", { class: "d-flex align-center mb-4" }, [
                                                createVNode(VIcon, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<h2 class="text-h6 font-weight-bold" data-v-37520040${_scopeId6}>${ssrInterpolate(unref(editingVkGroup) ? "Редактирование" : "Добавление")} VK группы</h2>`);
                                        } else {
                                          return [
                                    ...
                                    _push6(ssrRenderComponent(VCardText, { class: "pa-6" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Название группы</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          _push7(`</div><div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Ссылка на группу ВК</label>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          if (unref(newVkGroup).vkId && !unref(vkIdLoading)) {
                                            _push7(`<div class="text-caption text-green-darken-3 mt-1" data-v-37520040${_scopeId6}>`);
                                            _push7(ssrRenderComponent(VIcon, {
                                              size: "16",
                                              color: "green-darken-3"
                                            }, {
                                          ...
                                          if (unref(vkIdError)) {
                                            _push7(`<div class="text-caption text-red mt-1" data-v-37520040${_scopeId6}>${unref(vkIdError) ?? ""}</div>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          _push7(`<div class="text-caption text-grey-darken-1 mt-1" data-v-37520040${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, { size: "14" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`mdi-information-outline`);
                                              } else {
                                                return [
                                          ...
                                          _push7(` Поддерживаются: club123456, public123456, vk.com/название <a href="https://regvk.com/id/" target="_blank" class="text-decoration-none" style="${ssrRenderStyle({ "color": "#1976d2" })}" data-v-37520040${_scopeId6}>regvk.com</a></div></div><div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Курс</label>`);
                                          _push7(ssrRenderComponent(VSelect, {
                                          ...
                                          _push7(`</div><div class="mb-4" data-v-37520040${_scopeId6}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId6}>Токен сообщества</label><div class="d-flex ga-2" data-v-37520040${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VTextField, {
                                          ...
                                          if (unref(vkTestResult)) {
                                            _push7(`<div class="mt-2" data-v-37520040${_scopeId6}>`);
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  ...
                                                  if (unref(vkTestResult).details) {
                                                    _push8(`<div class="mt-1 text-grey-darken-1" data-v-37520040${_scopeId7}>${ssrInterpolate(unref(vkTestResult).details)}</div>`);
                                                  } else {
                                                    _push8(`<!---->`);
                                                  }
                                                } else {
                                          ...
                                          return [
                                            ...
                                            createVNode("div", { class: "mb-4" }, [
                                              ...
                                              createVNode("div", { class: "text-caption text-grey-darken-1 mt-1" }, [
                                                ...
                                                createTextVNode(" Поддерживаются: club123456, public123456, vk.com/название "),
                                                createVNode("a", {
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold mb-6" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>Email уведомления</h2>`);
                        _push4(ssrRenderComponent(VRow, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>SMTP Host</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>SMTP Port</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Email</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Пароль</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-6" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>From Email</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold mb-6" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>SEO оптимизация</h2>`);
                        _push4(ssrRenderComponent(VRow, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Заголовок сайта</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Описание</label>`);
                                    ...
                                    _push6(`</div><div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Ключевые слова</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                  ...
                  _push3(ssrRenderComponent(VWindowItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold mb-6" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-37520040${_scopeId3}>Общие настройки</h2>`);
                        _push4(ssrRenderComponent(VRow, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="mb-4" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Название сайта</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                                    ...
                                    _push6(`</div><div class="mb-6" data-v-37520040${_scopeId5}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-37520040${_scopeId5}>Email администратора</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-37520040"]]);

export { index as default };
//# sourceMappingURL=index-CBZgr08y.mjs.map
