import { toRef, useId, watch, shallowRef, ref, computed, toRaw, toValue, provide, inject, nextTick, createVNode, normalizeStyle, normalizeClass, withDirectives, createElementVNode, vShow, mergeProps, Fragment, toDisplayString, watchEffect } from 'vue';
import { E as useBackgroundColor, u as useBorder, a as useDensity, b as useDimension, c as useElevation, e as useRounded, j as useRender, R as Ripple, h as useLink, i as useVariant, m as makeVariantProps, k as makeTagProps, o as makeRoundedProps, r as makeElevationProps, s as makeDimensionProps, t as makeDensityProps, v as makeComponentProps, w as makeBorderProps, n as makeRouterProps, C as VDefaultsProvider, M as MaybeTransition, L as VExpandTransition, B as genOverlays, V as VIcon, z as useTextColor, D as deepEqual } from './index-BGySj97a.mjs';
import { g as genericComponent, b as provideTheme, i as useProxiedModel, c as provideDefaults, C as getCurrentInstance, t as focusChild, p as propsFactory, I as IconValue, m as makeThemeProps, O as EventProp, X as consoleError, a5 as isPrimitive, A as getPropertyFromItem, o as omit, w as wrapInArray, ag as defineComponent, a2 as deprecate, h as convertToUnit, d as pick } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-ZQn7gOuX.mjs';
import { d as createSimpleFunctional } from './position-BBaEnnBn.mjs';
import { V as VAvatar } from './VAvatar-CmpUZe0a.mjs';
...
export { VList as V, VListItem as a, VListSubheader as b, VListItemTitle as c, VListItemSubtitle as d, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-DlRcsxsa.mjs.map
