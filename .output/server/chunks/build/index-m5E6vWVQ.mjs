...
import { V as VAvatar } from './VAvatar-CwPHByUG.mjs';
import { V as VDialog } from './VDialog-CaFGQzyT.mjs';
import { V as VCard, a as VCardTitle, b as VCardText, c as VCardActions } from './VCard-Dpos_d6S.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-97939a15><div class="d-flex align-center mb-6" data-v-97939a15><div data-v-97939a15><h1 class="text-h4 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-97939a15>Пользователи</h1><p class="text-body-2 text-grey-darken-1" data-v-97939a15>Управление учениками</p></div>`);
      ...
      _push(ssrRenderComponent(VTable, { class: "data-table" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<thead data-v-97939a15${_scopeId}><tr data-v-97939a15${_scopeId}><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>Имя</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>Email</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>VK</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>Курсов</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>Дата</th><th class="text-left text-caption text-grey-darken-1 font-weight-medium" data-v-97939a15${_scopeId}>Действия</th></tr></thead><tbody data-v-97939a15${_scopeId}><!--[-->`);
            ssrRenderList(unref(users), (user) => {
              _push2(`<tr data-v-97939a15${_scopeId}><td data-v-97939a15${_scopeId}><div class="d-flex align-center" style="${ssrRenderStyle({ "gap": "12px" })}" data-v-97939a15${_scopeId}>`);
              if (user.avatar) {
                ...
                _push2(ssrRenderComponent(VAvatar, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(user.name?.charAt(0) || "?")}`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(user.name?.charAt(0) || "?"), 1)
                      ];
                    }
                  }),
                  _: 2
              ...
              _push2(`</div></td><td class="text-grey-darken-2" data-v-97939a15${_scopeId}>${ssrInterpolate(user.email)}</td><td data-v-97939a15${_scopeId}>`);
              if (user.vk) {
                _push2(`<a${ssrRenderAttr("href", `https://vk.com/id${user.vk}`)} target="_blank" class="text-decoration-none text-grey-darken-2" data-v-97939a15${_scopeId}> VK ${ssrInterpolate(user.vk)}</a>`);
              } else {
                _push2(`<span class="text-grey-lighten-1" data-v-97939a15${_scopeId}>—</span>`);
              }
              _push2(`</td><td class="text-grey-darken-2" data-v-97939a15${_scopeId}>${ssrInterpolate(user.coursesCount)}</td><td class="text-grey-darken-2" data-v-97939a15${_scopeId}>${ssrInterpolate(user.registered)}</td><td data-v-97939a15${_scopeId}><div class="d-flex ga-1" data-v-97939a15${_scopeId}>`);
                  ...
                  return openBlock(), createBlock("tr", {
                    ...
                    createVNode("td", null, [
                      createVNode("div", {
                        ...
                        user.avatar ? (openBlock(), createBlock(VAvatar, {
                          key: 0,
                          image: user.avatar,
                          size: "36"
                        }, null, 8, ["image"])) : (openBlock(), createBlock(VAvatar, {
                          key: 1,
                          size: "36",
                          style: { "background": "#e0e0e0", "color": "#666", "font-weight": "600" }
                        }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-97939a15${_scopeId3}>Создание пользователя</h2>`);
                      } else {
                        return [
                          createVNode("h2", {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VForm, { onSubmit: createUser }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="mb-4" data-v-97939a15${_scopeId4}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-97939a15${_scopeId4}>Имя</label>`);
                              ...
                              _push5(`</div><div class="mb-4" data-v-97939a15${_scopeId4}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-97939a15${_scopeId4}>Email</label>`);
                              _push5(ssrRenderComponent(VTextField, {
                              ...
                              _push5(`</div><div class="mb-4" data-v-97939a15${_scopeId4}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-97939a15${_scopeId4}>Пароль</label>`);
                              _push5(ssrRenderComponent(VTextField, {
                              ...
                              _push5(`</div><div class="mb-4" data-v-97939a15${_scopeId4}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-97939a15${_scopeId4}>VK ID</label>`);
                              _push5(ssrRenderComponent(VTextField, {
                              ...
                              _push5(`</div><div class="d-flex ga-2 mt-2" data-v-97939a15${_scopeId4}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-97939a15${_scopeId3}>Редактирование пользователя</h2>`);
                      } else {
                        return [
                          createVNode("h2", {
                            class: "text-h6 font-weight-bold",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-97939a15${_scopeId3}>Удалить пользователя?</h2>`);
                      } else {
                        return [
                          createVNode("h2", {
                            class: "text-h6 font-weight-bold",
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "pa-6 pt-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-body-2 text-grey-darken-2 mb-4" data-v-97939a15${_scopeId3}> Вы уверены, что хотите удалить пользователя <strong data-v-97939a15${_scopeId3}>${ssrInterpolate(unref(userToDelete)?.name)}</strong>? </p><p class="text-caption text-grey-darken-1" data-v-97939a15${_scopeId3}> Это действие нельзя отменить. </p>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-97939a15"]]);

export { index as default };
//# sourceMappingURL=index-m5E6vWVQ.mjs.map
