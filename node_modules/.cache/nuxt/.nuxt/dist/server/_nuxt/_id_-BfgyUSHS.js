import { defineComponent, reactive, ref, withCtx, createTextVNode, createVNode, unref, isRef, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, toDisplayString, useSSRContext } from "vue";
...
import { V as VRow, a as VCol } from "./VRow-8dNF8Cjb.js";
import { V as VForm } from "./VForm-BTR3xXyE.js";
import { V as VTextField } from "./VTextField-Dj5KxMoe.js";
import { V as VTextarea } from "./VTextarea-By9zHcBE.js";
import { V as VFileInput } from "./VFileInput-CuqyGoAs.js";
import { V as VSelect } from "./VSelect-F1bIdF9a.js";
import { V as VCheckbox } from "./VCheckbox-COGaGPsQ.js";
import { V as VChip } from "./VChip-DrZLESMo.js";
import { V as VDivider } from "./VDivider-D0tL2N8t.js";
...
import "./VList-BU_3CDSx.js";
import "./ssrBoot-ZQn7gOuX.js";
import "./VAvatar-CwPHByUG.js";
import "./VOverlay-DblaWLi6.js";
import "./scopeId-B2pAe-pO.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-53edc62a><div class="d-flex align-center mb-6" data-v-53edc62a>`);
      ...
      _push(`<div data-v-53edc62a><h1 class="text-h4 font-weight-bold mb-1" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-53edc62a> Редактирование курса </h1><p class="text-body-2 text-grey-darken-1" data-v-53edc62a> Изменение данных курса </p></div></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VForm, { onSubmit: saveCourse }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="mb-4" data-v-53edc62a${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId3}>Название</label>`);
                        ...
                        _push4(`</div><div class="mb-4" data-v-53edc62a${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId3}>Описание</label>`);
                        ...
                        _push4(`</div><div class="mb-6" data-v-53edc62a${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId3}>Фотография курса</label>`);
                        ...
                        if (unref(form).image) {
                          _push4(`<div class="mt-2" data-v-53edc62a${_scopeId3}><img${ssrRenderAttr("src", unref(form).image)} alt="Preview" style="${ssrRenderStyle({ "max-width": "200px", "max-height": "200px", "border-radius": "8px" })}" data-v-53edc62a${_scopeId3}></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div><div class="mb-6" data-v-53edc62a${_scopeId3}><label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId3}>Что вы получите</label><div class="mb-4" data-v-53edc62a${_scopeId3}><!--[-->`);
                        ssrRenderList(unref(form).benefits, (benefit, index) => {
                          _push4(`<div class="d-flex ga-2 mb-2" data-v-53edc62a${_scopeId3}>`);
                          _push4(ssrRenderComponent(VTextField, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId5}>Цена (₽)</label>`);
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId5}>Длительность</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId5}>Категория</label>`);
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<label class="text-caption text-grey-darken-1 d-block mb-1" data-v-53edc62a${_scopeId5}>Уроков</label>`);
                                    _push6(ssrRenderComponent(VTextField, {
                        ...
                        _push4(`<div class="d-flex ga-2" data-v-53edc62a${_scopeId3}>`);
                        _push4(ssrRenderComponent(VBtn, {
                          type: "submit",
                          color: "green-darken-3",
                          variant: "flat",
            ...
            _push2(ssrRenderComponent(VCol, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="preview-card" data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1 font-weight-medium mb-4" data-v-53edc62a${_scopeId2}>Предпросмотр</p><div class="mb-4" data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-53edc62a${_scopeId2}>Название</p><p class="text-body-2 font-weight-medium" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-53edc62a${_scopeId2}>${ssrInterpolate(unref(form).title || "Название курса")}</p></div><div class="mb-4" data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-53edc62a${_scopeId2}>Цена</p><p class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "color": "#020617" })}" data-v-53edc62a${_scopeId2}>${ssrInterpolate(unref(form).price ? `${unref(form).price} ₽` : "0 ₽")}</p></div><div class="mb-4" data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-53edc62a${_scopeId2}>Категория</p>`);
                  ...
                  _push3(`</div><div class="mb-4" data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-53edc62a${_scopeId2}>Статус</p>`);
                  _push3(ssrRenderComponent(VChip, {
                    size: "x-small",
                  ...
                  _push3(`<div data-v-53edc62a${_scopeId2}><p class="text-caption text-grey-darken-1" data-v-53edc62a${_scopeId2}>Описание</p><p class="text-body-2" data-v-53edc62a${_scopeId2}>${ssrInterpolate(unref(form).description || "Описание курса")}</p></div></div>`);
                } else {
                  return [
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-53edc62a"]]);
export {
  _id_ as default
};
//# sourceMappingURL=_id_-BfgyUSHS.js.map
