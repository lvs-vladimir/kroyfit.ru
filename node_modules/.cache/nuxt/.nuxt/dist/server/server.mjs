...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/new-BNeNo-ln.js")
  },
  {
    name: "admin-courses-id",
    path: "/admin/courses/:id()",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-zEJGmu7P.js")
  },
  {
    name: "admin-users-id",
    path: "/admin/users/:id()",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-48zJgh99.js")
  },
  {
    name: "admin-courses",
    path: "/admin/courses",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-BrNoHVvC.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/login-Dl0VUY8C.js")
  },
  {
    name: "admin-plan",
    path: "/admin/plan",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-ZSHME3Yl.js")
  },
  {
    name: "admin-purchases",
    path: "/admin/purchases",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-CaAoB1QG.js")
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-Cr8oSHDE.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-ClMf_w5Z.js")
  },
  {
    name: "courses-slug",
    path: "/courses/:slug()",
    component: () => import("./_nuxt/_slug_-CmETwZwH.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-0sHwVBlb.js")
  },
  {
    name: "cabinet",
    path: "/cabinet",
    component: () => import("./_nuxt/index-jh_WE-Tm.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/index-WGrr_Hjy.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BPRaAfao.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-BNgJsls_.js")
};
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-xOpsdd7D.js").then((m) => m.default || m))
};
