...
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "/root/kroyfit/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/new-BNV_780P.js")
  },
  {
    name: "admin-courses-id",
    path: "/admin/courses/:id()",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-BKvs0ZKV.js")
  },
  {
    name: "admin-users-id",
    path: "/admin/users/:id()",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/_id_-Dk-O-blu.js")
  },
  {
    name: "admin-courses",
    path: "/admin/courses",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-CZM2etMD.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/login-CNXDcoo3.js")
  },
  {
    name: "admin-plan",
    path: "/admin/plan",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-ssmWnw2v.js")
  },
  {
    name: "admin-purchases",
    path: "/admin/purchases",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-DYkve1MQ.js")
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-BYBd97CG.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-BQAPp_Fl.js")
  },
  {
    name: "courses-slug",
    path: "/courses/:slug()",
    component: () => import("./_nuxt/_slug_-DM4gNtGT.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-CQmkwJkw.js")
  },
  {
    name: "cabinet",
    path: "/cabinet",
    component: () => import("./_nuxt/index-C7Fp0jdC.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/index-BquGKNjP.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BBDjCUtF.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-o4siUiWx.js")
};
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-CW8jGbMs.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dy42h31u.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Jgk4NVy-.js"));
...
export {
  useGoTo as $,
  getPropertyFromItem as A,
  debounce as B,
  getCurrentInstance as C,
  useToggleScope as D,
  camelizeProps as E,
  ensureValidVNode as F,
  checkPrintable as G,
  callEvent as H,
  IconValue as I,
  ...
  consoleWarn as Q,
  asyncDataDefaults as R,
  createError as S,
  fetchDefaults as T,
  acceleratedEasing as U,
  deceleratedEasing as V,
  ...
  breakpoints as a1,
  deprecate as a2,
  PREFERS_REDUCED_MOTION as a3,
  includes as a4,
  isPrimitive as a5,
  isCssColor as a6,
  isParsableColor as a7,
  parseColor as a8,
  hasLightForeground as a9,
  findChildrenWithProvide as aa,
  useTheme as ab,
  useIcon as ac,
  flattenFragments as ad,
  hasEvent as ae,
  onlyDefinedProps as af,
  defineComponent as ag,
  pickWithRest as ah,
  defer as ai,
  defineNuxtRouteMiddleware as aj,
  provideTheme as b,
  useRtl as c,
  useLocale as d,
  entry_default as default,
  convertToUnit as e,
  useProxiedModel as f,
  ...
  omit as o,
  propsFactory as p,
  matchesSelector as q,
  isClickInsideElement as r,
  standardEasing as s,
  focusChild as t,
  useRoute as u,
  getNextElement as v,
